...
def get_data_loaders(batch_size: int = 32, valid_size: float = 0.2, num_workers: int = -1, limit: int = -1):
    ...
    data_transforms = {
        "train": transforms.Compose([
            ...
            transforms.RandAugment(num_ops=2, magnitude=rand_augment_magnitude, interpolation=transforms.InterpolationMode.BILINEAR, ),
            transforms.RandomAffine(degrees=Angle_ran, translate=Translate_ran, scale=Scale_ran, shear=Shear_ran),
            transforms.ToTensor(),
